<main>
  ...
  <p>
    ...
    네이버 커넥트 재단에서 제공하는 <code>boostcourse</code>에서 코드리뷰를 받으면 본격적으로 공부를 시작했습니다.<br />
    이후에는 학습을 지속하기 위해 여러 부트캠프(<code>boostcamp</code>, <code>codesquad</code>)들에 참여하였습니다.<br />
